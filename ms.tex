...
the 27.4 day baseline of \TESS\ fields will limit measureable rotation periods
...
We have identified 34 stars in 17 pairs with \Gaia\ proper motions and radial
velocities from \RAVE\ that are observable by \TESS
% \footnote{Based on {\tt tvguide}.}
and are already in the Candidate Target List.
...
first \Gaia\ data release \citep{oh2016} to quantify the accuracy and
...
best fit estimates for around 30,000 high priority FFI targets and a catalog
of rotation periods for lower priority FFI stars using a combination of
